export const maharashtraData: Record<string, string[]> = {
  ...
  Amravati: ['Achalpur', 'Amravati', 'Anjangaon Surji', 'Chandur Bazar', 'Chikhaldara', 'Daryapur', 'Dhamangaon Rly', 'Morshi', 'Nandgaon Khandeshwar', 'Teosa', 'Warud'],
  ...
  Nagpur: ['Bhiwapur', 'Hingna', 'Kamptee', 'Katol', 'Kalmeshwar', 'Kuhi', 'Mauda', 'Nagpur Rural', 'Nagpur Urban', 'Narkhed', 'Parseoni', 'Ramtek', 'Savner', 'Umred'],
  ...
  Raigad: ['Alibag', 'Karjat', 'Khalapur', 'Mahad', 'Mangaon', 'Murud', 'Panvel', 'Pen', 'Poladpur', 'Roha', 'Shrivardhan', 'Sudhagad', 'Tala', 'Uran'],
